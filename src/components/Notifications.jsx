...
const Chat = () => {
  ...
  return (
    <div className='mainChat mainNoti bg-white dark:bg-[#484B52] dark:text-white border'>
      <div className='chatHeader'>
        <h4 className='font-extrabold text-xl'>Notifications</h4>
        <button
            type="button"
            onClick={() => {
              handleClick(false);
      ...
      <div className='chatBody'>
          ...
          <button className=' text-white' style={{backgroundColor:currentColor}}> All Notifications</button>
      </div>
    </div>
  )
}
